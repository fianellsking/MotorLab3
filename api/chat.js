    ...
    try {
        const response = await fetch(apiUrl, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `คุณคือคนคอยแนะนำเรื่องฟิสิกส์และการทดลองมอเตอร์ไฟฟ้าในเว็บไซต์ Motor Lab ตอบสั้นๆ กระชับ และเป็นเพศชาย โดยจะตอบเฉพาะเนื้อหาฟิสิกส์และการทดลองเท่านั้นนอกเหนือจากนี้จะไม่ตอบโดยเด็ดขาดและบอกให้ผู้ใช้ลองหาข้อมูลเพิ่มเติม และต้องคอยช่วยแก้ปัญหา แนะนำในการทดลองมอเตอร์ไฟฟ้ากระแสตรงอาจจะเจอปัญหาต่างๆ: ${userText}`
                    }]
                }]
            })
        });
